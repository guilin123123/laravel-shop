...
class CreateInstallmentItemsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('installment_items', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('installment_id')->comment('分期表id');
            ...
            $table->string('refund_status')->default(\App\Models\InstallmentItem::REFUND_STATUS_PENDING)->comment('退款状态,默认未退款');
            $table->timestamps();
        });
    }
