...
class InstallmentsController extends Controller
{
    ...
    public function payByAlipay(Installment $installment)
    {
        ...
        return app('alipay')->web([
            ...
            // 覆盖掉AppServiceProvider设置的回调地址
            'notify_url' => ngrok_url('installments.alipay.notify'), //服务器回调
            'return_url' => route('installments.alipay.return'), //网页回调
        ]);
    }
